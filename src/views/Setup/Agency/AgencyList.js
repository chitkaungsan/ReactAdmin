...
const columns= [
  {
    ...
    name: 'Office Rule Name',
    selector: row => row.officeRuleName,
    sortable: true,
    grow: 2
  }, {
         name:"Action",
...
const fetchData = async () =>{
  await axios.get(`${process.env.REACT_APP_API_URL}/api/get/agency`,config)
  .then(({data})=>{
...
const _handleSync = () => {
    setBtnLoad(false);
     axios.get(`${process.env.REACT_APP_API_URL}/api/get/fetch/agency`,config)
  .then(({data})=>{
